...
async function VaultLoad() {
    ...
    document.documentElement.innerHTML = "<html><style>body {background: black; color: white; font-family: arial; font-size: 25px; text-align: center; padding-top: 50%;}</style></head><body><h1>LOADING...</h1></html>";
